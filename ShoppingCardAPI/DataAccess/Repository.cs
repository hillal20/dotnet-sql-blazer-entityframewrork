...
namespace ShoppingCardAPI.DataAccess
{
    public class Repository : DbContext
    {
        public Repository(DbContextOptions<Repository> dbContextOptions): base(dbContextOptions)
        {
        }
        ...
        // the following override method is to seed the data into the database during the creation of the models of the database
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
			...
			modelBuilder.Entity<Product>().HasData(new Entities.Product
            {
				Id = 23,
